...
void CFrustum::update(CVector3 eyePos, CVector3 lookAtPos, CVector3 upVector, CVector3 right, float nearDistance, float farDistance, float fov, float aspectRatio)
{
	...
	*/
	...
	CVector3 farCenter       = eyePos + (CVector3(forwardVector.X * farDistance, forwardVector.Y * farDistance, forwardVector.Z * farDistance));
	float    HFarOver2       = Hfar / 2.0f;
	float    WFarOver2       = Wfar / 2.0f;
	CVector3 upHFarOver2     = CVector3(upVector.X * HFarOver2, upVector.Y * HFarOver2, upVector.Z * HFarOver2);
	CVector3 rightWFarOver2  = CVector3(right.X * WFarOver2, right.Y * WFarOver2, right.Z * WFarOver2);
	...
	CVector3 nearCenter      = eyePos + (CVector3(forwardVector.X * nearDistance, forwardVector.Y * nearDistance, forwardVector.Z * nearDistance));
	float    HNearOver2      = Hnear / 2.0f;
	float    WNearOver2      = Wnear / 2.0f;
	CVector3 upHNearOver2    = CVector3 (upVector.X * HNearOver2, upVector.Y * HNearOver2, upVector.Z * HNearOver2);
	CVector3 rightWNearOver2 = CVector3 ( right.X * WNearOver2, right.Y * WNearOver2, right.Z * WNearOver2);
